...
function clickColumna(_event) {
    //Segúm si i sea o no múltiplo de 2, le tocará a un jugador u otro, añadiendo 1 a i a cada movimiento, de modo que se vayan alternando los turnos
    if (i%2==0) {
        ...
        //Como al termionar las rojas, se le ha añadido 1 a i, ahora es el turno de las azules
        if (mouseX >= 100-75/2 && mouseX <= 100+75/2 && a < 6) {
            fill(0,0,255);
            ellipse(100, 600-100*a, 75,75);
            i=i+1;
...
//Faltaría poner quién juega, que cuando haya un 4 en raya se pare el juego y diga quién gana y hacer más estética la caída de la ficha